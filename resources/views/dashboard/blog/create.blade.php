    ...
    <form action="{{ route('dashboard.blog.store') }}" method="POST" class="grid lg:grid-cols-2 gap-3 p-4 rounded-[4px] border border-[#0d1117]/[0.12]" enctype="multipart/form-data">
        ...
        <div class="lg:col-span-2">
            ...
            <div class="wrapper mt-2 flex items-end gap-[6px]">
                <img src="https://placehold.co/400x400?text=Image+Not+Found" alt="Foto Blog" class="w-[100px] aspect-square rounded-[4px] object-cover border border-[#0d1117]/[0.12]">
        ...
        <div class="lg:col-span-2">
            ...
            <textarea rows="6" id="description" name="description" class="w-full mt-2 p-3 rounded-black text-[#0d1117] border border-[#0d1117]/[0.12] rounded-[4px]" required></textarea>
        </div>
