            ...
            <div class=" bg-white rounded-lg shadow-md p-4  border-1 border-gray-300 flex flex-col gap-1">
                ...
                <div class="flex gap-6">
                    <img src="{{ asset('images/landing-page.png') }}" alt="Pengaduan Image"
                        class="w-[450px] h-[450px] object-cover rounded-lg ">
                    <div class="flex flex-col gap-2">
                        <div class ="flex justify-between items-center">
                            <h3 class="text-[20px] font-semibold ">Gedung A Rusak</h3>
                            <p class="text-gray-600 text-sm">01 Januari 2025</p>
                        </div>
                        <p class="text-[16px] text-justify">Lorem ipsum dolor sit amet consectetur, adipisicing elit.
                            Aliquam
                            ...
                            similique hic, sequi adipisci quasi corporis, commodi illum amet temporibus sed tenetur
                            inventore?
                            Vel dolore ducimus consequuntur magni voluptas non earum debitis minus ut, aperiam omnis
                            explicabo
                            rem esse. At, quo. Quas veritatis neque reiciendis. Omnis quidem, rem sed obcaecati
                            necessitatibus,
                            eligendi earum fugit iusto nisi assumenda illo, natus nulla inventore ipsam quos fuga quae odit.
                        </p>
                ...
                <div class="mt-6 border-1 p-2 rounded-lg border-gray-300">
                    ...
                    <div class="flex flex-col gap-4 mb-4">
                        ...
                        <div class="flex items-start gap-2">
                            <img src="https://ui-avatars.com/api/?name=Anonymus" alt="avatar"
                    ...
                    <form class="flex items-center gap-2 mt-2">
                        <input type="text" class="flex-1 border border-gray-300 rounded-lg p-2 text-sm"
