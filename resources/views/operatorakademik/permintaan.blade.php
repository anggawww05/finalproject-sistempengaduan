            ...
            <table class="min-w-full bg-gray-50 border border-gray-200 rounded-lg">
                ...
                <thead>
                    <tr>
                        ...
                        <th class="px-4 py-3 bg-[#141414] text-white text-left font-medium">Aksi</th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <tr class="border-b">
                        ...
                        <td class="px-4 py-2 text-left">{{$report->user->name}}</td>
                        <td class="px-4 py-2 text-left">{{$report->title}}</td>
                        <td class="px-4 py-2 text-left">{{$report->created_at->format('Y-m-d')}}</td>
                        <td class="px-4 py-2 text-left">
                            <a href="#" class="inline-block bg-blue-600 hover:bg-blue-700 text-white text-xs px-3 py-1 rounded transition">Detail</a>
                        </td>
                        <td class="px-4 py-2 text-left">
                            <a href="#" class="inline-block bg-blue-600 hover:bg-blue-700 text-white text-xs px-3 py-1 rounded transition">Konfirmasi</a>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
