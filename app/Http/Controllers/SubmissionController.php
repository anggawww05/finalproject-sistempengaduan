...
//        ]);
//
//        $submissionCount = Submission::where('status', 'approve')->count() + 1;
//        $submissionNumber = str_pad($submissionCount, 3, '0', STR_PAD_LEFT);
//        $date = date('dmY');
//        $random = strtoupper(Str::random(4));
//        $validated['ticket_number'] = 'SIPMA-' . $submissionNumber . '-' . $date . '-' . $random;
